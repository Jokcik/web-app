...
async function bootstrap() {
  ...
  app.use(cors({allowedOrigins: ['localhost:4200', 'localhost:8080', 'rumc31.ru:8080', 'localhost:3001', 'rumc31.ru', '85.143.175.134'], headers: ['Content-Type', 'enctype', 'Authorization']}));
